...
target = "CLASS"
file_tag = "CLASS"
train: DataFrame = read_csv("/home/mina/Documents/portugal/dataScience/train_dataset_2.csv")

print("Original variables", train.columns.to_list())
vars2drop: list[str] = select_low_variance_variables(train, 0.7, target=target)
...
def study_variance_for_feature_selection(
    ...
    savefig(f"/home/mina/Documents/portugal/dataScience/Data_science_project/feature_engineering/images/{file_tag}_fs_low_var_{metric}_study.png")
    return results


eval_metric = "recall"
test: DataFrame = read_csv("/home/mina/Documents/portugal/dataScience/test_dataset_2.csv")
...
train_cp, test_cp = apply_feature_selection(
    train, test, vars2drop, filename=f"/home/mina/Documents/portugal/dataScience/{file_tag}", tag="lowvar"
)
...
def study_redundancy_for_feature_selection(
    ...
    savefig(f"/home/mina/Documents/portugal/dataScience/Data_science_project/feature_engineering/images/{file_tag}_fs_redundancy_{metric}_study.png")
    return results
...
train_cp, test_cp = apply_feature_selection(
    train, test, vars2drop, filename=f"/home/mina/Documents/portugal/dataScience/{file_tag}", tag="redundant"
)
print(f"Original data: train={train.shape}, test={test.shape}")
